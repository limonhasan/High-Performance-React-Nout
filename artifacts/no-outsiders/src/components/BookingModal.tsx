...
export default function BookingModal({ isOpen, onClose, event }: BookingModalProps) {
  ...
  const handleConfirm = () => {
    ...
    const message = encodeURIComponent(
      `Hi No Outsiders! I want to book ${quantity} ticket${Number(quantity) > 1 ? "s" : ""} for ${event.name}. My name is ${name}.`
    );
          ...
          >
            <div className="glassmorphism w-full max-w-md p-0 overflow-hidden">
              ...
              <div className="relative bg-[#E31212] px-6 py-5">
                <div className="sub-headline text-white font-bold text-xs tracking-widest mb-1">
                  BOOK YOUR SPOT
                </div>
              ...
              <div className="px-6 py-6">
                {/* Event Details */}
                <div className="flex items-center gap-4 mb-6 p-4 border border-[#E31212]/30 bg-[#E31212]/5">
                  <div>
                    <div className="sub-headline text-[#E31212] text-xs mb-1">PRICE</div>
                    <div className="headline text-white text-xl">{event.price}</div>
                  </div>
                  <div className="w-px h-10 bg-[#E31212]/30" />
                  <div>
                    <div className="sub-headline text-[#E31212] text-xs mb-1">DATE</div>
                    <div className="text-white text-sm font-medium">{event.date}</div>
                  </div>
                  <div className="w-px h-10 bg-[#E31212]/30" />
                  <div>
                    <div className="sub-headline text-[#E31212] text-xs mb-1">VENUE</div>
                ...
                <div className="space-y-4 mb-6">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full bg-black border-2 border-white/20 focus:border-[#E31212] text-white px-4 py-3 text-sm outline-none transition-colors appearance-none cursor-pointer"
                    >
                      {[1, 2, 3, 4, 5].map((n) => (
